...
public class TransformConstraintTest {
    ...
    private static final Token SUB = seq(
                                         def("ptr1", 1),
                                         sub(OUTER, lastRef("ptr1")));

    private static final Token DOUBLE_SUB_INNER2 = str("INNER2", def("value", 1));

    private static final Token DOUBLE_SUB_INNER1 = str("INNER1",
                                                       seq(
                                                           def("ptr2", 1),
                                                           sub(DOUBLE_SUB_INNER2, lastRef("ptr2"))));

    private static final Token DOUBLE_SUB = str("OUTER",
                                                seq(
                                                    def("ptr1", 1),
                                                    sub(DOUBLE_SUB_INNER1, lastRef("ptr1"))));
    ...
    public void testValid() throws IOException {
        ...
        assertTrue(transformConstraint.isSatisfiedBy(result.environment));
    }
    ...
    public void missingScope() throws IOException {
        ...
        assertTrue(result.succeeded);
        assertFalse(transformConstraint.isSatisfiedBy(result.environment));
    }
    ...
    public void testValidExpression() throws IOException {
        ...
        final TransformConstraint transformConstraint = new TransformConstraint(eqNum(lastRef("value"), con(1)));
    ...
    public void testInvalidExpression() throws IOException {
        ...
        final TransformConstraint transformConstraint = new TransformConstraint(eqNum(lastRef("value"), con(2)), INNER);
    ...
    public void doubleSubToOuterWithoutIntermediateWithInvalidExpression() throws IOException {
        ...
        final TransformConstraint transformConstraint = new TransformConstraint(eqNum(lastRef("value"), con(43)), DOUBLE_SUB, DOUBLE_SUB_INNER2);
    ...
    public void testAndExpression() throws IOException {
        ...
        final TransformConstraint transformConstraint = new TransformConstraint(and(eqNum(lastRef("value1"), con(1)), eqNum(lastRef("value3"), con(3))));
    ...
    public void testExpressionNonExistingValue() throws IOException {
        ...
        final TransformConstraint transformConstraint = new TransformConstraint(eqNum(lastRef("value0"), con(1)));
