...
public final class UDP {
    ...
    /** Data size in octets. */
    public static final ValueExpression DATA_SIZE = sub(lastRef("udplength"), HEADER_SIZE);
    ...
    public static final Token DATA = cho(
                                         seq(
                                             DNS.FORMAT,
                                             def("padding", sub(lastRef("udplength"), sub(currentOffset, offset(lastRef("sourceport")))), eqNum(con(0)))),
